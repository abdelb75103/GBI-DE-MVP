...
const papers = [
  ...
  {
    sid: 'S660', cov: '#744', batch: '068', labels: ['1985 artificial turf', '1986 artificial turf', '1986 gravel', '1986 total'],
    summary: 'Engebretsen/Kase 1987 Norwegian winter-series surface study extracted as artificial-turf/gravel rows where direct surface injury counts are reported; location/type tables use the reported 1986 total column rather than assigning those totals to artificial turf.',
    fields: {
      ...
      [f('studyDetails', 'studyDesign')]: 'prospective cohort',
      [f('participantCharacteristics', 'fifaDiscipline')]: join(top('Association football (11-a-side)', 4)),
      [f('participantCharacteristics', 'country')]: join(top('Norway', 4)),
      [f('participantCharacteristics', 'levelOfPlay')]: join(top('elite / first and second division winter series', 4)),
      [f('participantCharacteristics', 'sex')]: join(top('male', 4)),
      [f('participantCharacteristics', 'ageCategory')]: join(top('Senior', 4)),
      [f('participantCharacteristics', 'numberOfTeams')]: join(top('16', 4)),
      [f('participantCharacteristics', 'observationDuration')]: join(['1985 winter series artificial', '1986 winter series artificial', '1986 winter series gravel', '1986 winter series total']),
      [f('definitions', 'injuryDefinition')]: 'time-loss',
      [f('definitions', 'incidenceDefinition')]: 'per 1000 match hours',
      [f('definitions', 'mechanismReporting')]: 'Medical Staff',
      [f('exposure', 'exposureMeasurementUnit')]: join(top('match-exposures', 4)),
