...
3. **Click "New query"**
4. **Open the file**: `APPLY_THIS_SQL.sql` (in the root folder)
...
- `APPLY_THIS_SQL.sql` - The SQL to run (ROOT folder)
- `verify-setup.mjs` - Verification script (fifa-gbi-data-extraction folder)
- `CONFIGURATION_CHECKLIST.md` - Detailed setup info

---

**Need help?** All the SQL is in `APPLY_THIS_SQL.sql` - just copy-paste it into Supabase SQL Editor and hit Run!
