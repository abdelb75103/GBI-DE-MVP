  ...
  return (
    <header className="sticky top-0 z-40 border-b border-line bg-surface">
      <div className="mx-auto w-full max-w-screen-2xl px-4 sm:px-6">
        <div className="grid min-w-0 grid-cols-[minmax(0,1fr)_auto] items-center gap-3 py-2.5 lg:grid-cols-[auto_minmax(0,1fr)_auto]">
          <Link
            href="/dashboard"
            className="flex min-w-0 items-center gap-3 rounded-ctl transition-opacity duration-[160ms] ease-gbi hover:opacity-80 focus-visible:outline-none focus-visible:shadow-focus"
          >
            ...
            <span className="border-l border-line pl-3 text-[15px] font-semibold leading-tight tracking-[-0.01em] text-ink sm:text-base">
              FIFA GBI
            </span>
          </Link>
          ...
          <div className="flex min-w-0 items-center justify-end gap-3">
            {/* Dark mode is built but not exposed yet: the theme toggle is hidden
                until the migration is verified in light. Re-render
                <ThemeToggleButton /> here to bring it back. */}
