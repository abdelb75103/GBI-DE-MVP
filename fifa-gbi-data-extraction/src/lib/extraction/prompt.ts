...
export function buildExtractionPrompt(options: PromptOptions) {
  ...
  return [
    ...
    '   ',
    '   mechanismReporting:',
    '   - "Medical Staff" | "Coach" | "Player-selfreported" | "other" | free text',
    '   - Extract who reported the injury data (e.g., medical staff, coaches, players themselves)',
    '   - Use standardized values when applicable, otherwise return free text as reported',
    '   ',
    '   B. NUMERICAL FIELDS:',
    '   ',
