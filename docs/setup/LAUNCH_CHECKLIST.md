...
- [ ] **Run `sql/setup/clear-test-data.sql` in Supabase Dashboard**
  - Go to Supabase Dashboard > SQL Editor
  - Copy-paste `sql/setup/clear-test-data.sql`
  - Click Run
...
- [ ] **Run `sql/setup/setup-production-passwords.sql` in Supabase Dashboard**
  - Go to Supabase Dashboard > SQL Editor
  - Copy-paste `sql/setup/setup-production-passwords.sql`
  - Click Run
...
- [ ] **Run `sql/setup/verify-launch-setup.sql` in Supabase Dashboard**
  - Go to Supabase Dashboard > SQL Editor
  - Copy-paste `sql/setup/verify-launch-setup.sql`
  - Click Run
  - Review all checks
...
✅ **SQL Scripts:**
- `sql/setup/clear-test-data.sql` - Clears all test data
- `sql/setup/setup-production-passwords.sql` - Creates auth.users entries with passwords
- `sql/setup/verify-launch-setup.sql` - Verifies setup is complete
...
1. **Run SQL scripts** in Supabase Dashboard (in order):
   - `sql/setup/clear-test-data.sql`
   - `sql/setup/setup-production-passwords.sql`
   - `sql/setup/verify-launch-setup.sql`
