...
2. Copy-paste **`sql/setup/clear-test-data.sql`** → Run
3. Verify all counts show 0 ✅

### Step 2: Set Up Passwords

1. In Supabase Dashboard > SQL Editor
2. Copy-paste **`sql/setup/setup-production-passwords.sql`** → Run
3. Review verification output ✅

### Step 3: Verify Setup

1. In Supabase Dashboard > SQL Editor
2. Copy-paste **`sql/setup/verify-launch-setup.sql`** → Run
