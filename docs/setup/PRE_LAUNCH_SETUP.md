...
3. Click **"New query"**
4. Open the file: `sql/setup/clear-test-data.sql` (in the root folder)
...
The SQL script (`sql/setup/setup-production-passwords.sql`) will automatically generate passwords for all profiles using the format:
...
2. Click **"SQL Editor"** in the left sidebar
3. Click **"New query"**
4. Open the file: `sql/setup/setup-production-passwords.sql` (in the root folder)
5. Copy **ALL the SQL** from that file
6. Paste it into the Supabase SQL Editor
7. Click **"Run"** (or press Cmd+Enter / Ctrl+Enter)
